...
var ErrorBar = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(ErrorBar, [{
    ...
    value: function render() {
      ...
      !!(this.props.direction === 'x' && xAxis.type !== 'number') ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, 'ErrorBar requires Axis type property to be "number".') : tinyInvariant() : void 0;
