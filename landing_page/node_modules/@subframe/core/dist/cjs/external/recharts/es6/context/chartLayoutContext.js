...
var useXAxisOrThrow = function useXAxisOrThrow(xAxisId) {
  ...
  !(xAxisMap != null) ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, 'Could not find Recharts context; are you sure this is rendered inside a Recharts wrapper component?') : tinyInvariant() : void 0;
  var xAxis = xAxisMap[xAxisId];
  !(xAxis != null) ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, "Could not find xAxis by id \"".concat(xAxisId, "\" [").concat(_typeof(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : tinyInvariant() : void 0;
  return xAxis;
};
...
var useYAxisOrThrow = function useYAxisOrThrow(yAxisId) {
  var yAxisMap = React.useContext(YAxisContext);
  !(yAxisMap != null) ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, 'Could not find Recharts context; are you sure this is rendered inside a Recharts wrapper component?') : tinyInvariant() : void 0;
  var yAxis = yAxisMap[yAxisId];
  !(yAxis != null) ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, "Could not find yAxis by id \"".concat(yAxisId, "\" [").concat(_typeof(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : tinyInvariant() : void 0;
  return yAxis;
};
